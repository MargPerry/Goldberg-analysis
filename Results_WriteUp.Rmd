...
```{r PSAI Score vs. Household Dvision of Labor}
...
#Model 3- PSAI Score vs. Household Division of Labor for families with Heterosexual and Homosexual Parents
```{r}
L3<- lm(PAIst~HHT_HouseMean+sexor, data=Goldberg_Callie_SR, na.action = na.exclude)

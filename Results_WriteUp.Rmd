...
<p> 
Hypothesis 1: 
We hypothesized that households with an unequal distribution of labor will be associated with whether a child displays gendered play.

<p> 
Hypothesis 2: 
We hypothesize that unequal division of labor in heterosexual couples will have a greater effect on gendered play in children than the labor disruption in same-sex couples.
...
Goldberg_Callie_SR<-Goldberg_Callie_SR%>%
  mutate(PAIst= ifelse(Goldberg_Callie_SR$w14chgender_1==-1,

...
>>>>>>> ff375aed6a57903423256ce5eba8453e55292718
...
Goldberg_callie_SR_2<-goldberg_psai%>%
  mutate(pai= round((w16rt2+ w16rt4+ w16rt7 + w16ra1 + w16ra2 + w16ra3 + w16ra6 + w16ra9 + w16ra11 + w16rc4 + w16rc5 + w16rc6 + w16charac1_1+ w16charac2_1+ w16charac3_1+ w16toys1_1+ w16toys3_1 + w16toys5_1+ w16toys6_1+ w16activ4_1+ w16activ5_1+ w16activ7_1+ w16activ8_1+ w16activ10_1) /23))
>>>>>>> ff375aed6a57903423256ce5eba8453e55292718
...
Goldberg_Callie_SR<-Goldberg_Callie_SR%>%
  mutate(w16PSAI = ifelse(Goldberg_Callie_SR$w14chgender_1==-1,
...
```{r, include = FALSE}
Goldberg_Callie_SR<- Goldberg_Callie_SR%>%
  mutate(HHT_HouseMean= rowMeans(Goldberg_Callie_SR
          %>% select(w14HHT1_1, w14HHT2_1, w14HHT3_1, w14HHT4_1, w14HHT5_1, w14HHT6_1,w14HHT7_1, w14HHT8_1, w14HHT9_1, w14HHT10_1,  w14HHT11_1, w14HHT12_1, w14HHT13_1, w14HHT14_1,
w14HHT1_2, w14HHT2_2, w14HHT3_2, w14HHT4_2, w14HHT5_2, w14HHT6_2,w14HHT7_2, w14HHT8_2, w14HHT9_2, w14HHT10_2, w14HHT11_2, w14HHT12_2, w14HHT13_2, w14HHT14_2), na.rm = TRUE))
...
```{r include=FALSE}
L1<- lm(w16PSAI~HHT_HouseMean, data=Goldberg_Callie_SR, na.action = na.exclude)
summary(L1)
=======
```{r, include = FALSE}
L1<- lm(PAIst~HHT_HouseMean, data=Goldberg_Callie_SR, na.action = na.exclude)
...
```
<<<<<<< HEAD
#Model 2- PSAI Score vs. Household Division of Labor Equality

```{r include=FALSE}
L2<- lm(w16PSAI~EqualPercp, data=Goldberg_Callie_SR, na.action = na.exclude)
...
```
#Model 3- PSAI Score vs. Parental makeup 
```{r include=FALSE}
L3<- lm(w16PSAI~ sexor, data=Goldberg_Callie_SR, na.action = na.exclude)
...
```{r, include = FALSE}
L2<- lm(PAIst~EqualPercp, data=Goldberg_Callie_SR, na.action = na.exclude)
```

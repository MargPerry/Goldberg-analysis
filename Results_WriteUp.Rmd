...
```{r}
L2<- lm(w16PSAI~ sexor, data=Goldberg_Callie_SR, na.action = na.exclude)
...
#Model 3
```{r}
ggplot(data = Goldberg_Callie_SR, aes(x= sexor, y =HHT_HouseMean))+geom_point()+labs(title="Divsion of Labour and Parental Gender Composition", y="Household Tasks Distribution", x="Parental Gender Composition" )
```
